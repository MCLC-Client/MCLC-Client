...
This project follows the guidelines of [Keep a Changelog](https://keepachangelog.com/en/1.1.0/](https://keepachangelog.com/) and adheres to [Semantic Versioning](https://semver.org/).
